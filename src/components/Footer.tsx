...
const Footer = () => {
  ...
  return (
    <footer className="bg-black/80 backdrop-blur-sm border-t border-accent/20 mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <div className="flex flex-col space-y-2 items-center md:items-end">
              <Link to="/cookies" className="text-white hover:text-accent transition-colors">
                {t('footer.cookiePolicy')}
              </Link>
              <Link to="https://app-fudfate.blackmouthgames.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent transition-colors">
                {t('nav.app')}
              </Link>
            </div>
          </div>
